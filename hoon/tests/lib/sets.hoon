...
++  test-jeam
  %+  expect-eq:test
    !>  ^-  jock:jock
        :: [%let type=[p=[%atom p=%number q=%.n] name=%a] val=[%set type=[%none ~] val={[%atom p=[[%number 1] %.n]]}] next=[%let type=[p=[%atom p=%number q=%.n] name=%b] val=[%set type=[%none ~] val={[%atom p=[[%number 1] %.n]] [%atom p=[[%number 2] %.n]]}] next=[%let type=[p=[%atom p=%number q=%.n] name=%c] val=[%set type=[%none ~] val={[%atom p=[[%number 3] %.n]] [%atom p=[[%number 1] %.n]] [%atom p=[[%number 2] %.n]]}] next=[%let type=[[p=[p=[%atom p=%number q=%.n] name=%$] q=[p=[%atom p=%number q=%.n] name=%$]] name=%d] val=[%set type=[%none ~] val={[p=[%atom p=[[%number 3] %.n]] q=[%atom p=[[%number 4] %.n]]] [p=[%atom p=[[%number 1] %.n]] q=[%atom p=[[%number 2] %.n]]]}] next=[%let type=[[p=[p=[%atom p=%number q=%.n] name=%$] q=[p=[%none ~] name=%$]] name=%e] val=[%set type=[%none ~] val={[p=[%atom p=[[%number 3] %.n]] q=[%set type=[%none ~] val={[%atom p=[[%number 5] %.n]] [%atom p=[[%number 4] %.n]]}]] [p=[%atom p=[[%number 1] %.n]] q=[%set type=[%none ~] val={[%atom p=[[%number 2] %.n]]}]]}] next=[p=[%limb p=~[[%name p=%a]]] q=[p=[%limb p=~[[%name p=%b]]] q=[p=[%limb p=~[[%name p=%c]]] q=[p=[%limb p=~[[%name p=%d]]] q=[%limb p=~[[%name p=%e]]]]]]]]]]]]
        *jock:jock
    !>  (jeam:jock text)
::
++  test-mint
