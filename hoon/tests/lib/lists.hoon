...
++  test-jeam
  %+  expect-eq:test
    !>  ^-  jock:jock
        [%let type=[p=[%untyped ~] name=%a] val=[p=[%atom p=[%number 1]] q=[p=[%atom p=[%number 2]] q=[p=[%atom p=[%number 3]] q=[p=[%atom p=[%number 4]] q=[p=[%atom p=[%number 5]] q=[%atom p=[%number 0]]]]]]] next=[%let type=[p=[%untyped ~] name=%b] val=[p=[%atom p=[%number 6]] q=[p=[%atom p=[%number 7]] q=[p=[%atom p=[%number 8]] q=[p=[%atom p=[%number 9]] q=[p=[%atom p=[%number 10]] q=[%atom p=[%number 0]]]]]]] next=[p=[%limb p=~[[%name p=%a]]] q=[%limb p=~[[%name p=%b]]]]]]
    !>  (jeam:jock text)
::
++  test-mint
  %+  expect-eq:test
