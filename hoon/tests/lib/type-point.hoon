...
|%
++  text
  'compose\0a  class Point(x:@ y:@) {\0a    // new() is the required constructor\0a    new(p:Point) -> Point {\0a      // the return from any method must match the state shape\0a      (p.x p.y)\0a    }\0a    add(p:Point q:Point) -> Point {\0a      // we do not have infix operators yet so this is just a weird hack\0a      (p.x q.y)\0a    }\0a    copy(p:Point) -> Point {\0a      // return the current state\0a      (p.x p.y)\0a    }\0a  }; // end compose\0a\0a// uses the implicit new() constructor\0alet origin = Point(50 60);\0a\0aorigin'
++  test-tokenize
  %+  expect-eq:test
    !>  ~[[%keyword %compose] [%keyword %class] [%type 'Point'] [%punctuator %'(('] [%name %x] [%punctuator %':'] [%punctuator %'@'] [%name %y] [%punctuator %':'] [%punctuator %'@'] [%punctuator %')'] [%punctuator %'{'] [%name %new] [%punctuator %'(('] [%name %p] [%punctuator %':'] [%type 'Point'] [%punctuator %')'] [%punctuator %'-'] [%punctuator %'>'] [%type 'Point'] [%punctuator %'{'] [%punctuator %'('] [%name %p] [%punctuator %'.'] [%name %x] [%name %p] [%punctuator %'.'] [%name %y] [%punctuator %')'] [%punctuator %'}'] [%name %add] [%punctuator %'(('] [%name %p] [%punctuator %':'] [%type 'Point'] [%name %q] [%punctuator %':'] [%type 'Point'] [%punctuator %')'] [%punctuator %'-'] [%punctuator %'>'] [%type 'Point'] [%punctuator %'{'] [%punctuator %'('] [%name %p] [%punctuator %'.'] [%name %x] [%name %q] [%punctuator %'.'] [%name %y] [%punctuator %')'] [%punctuator %'}'] [%name %copy] [%punctuator %'(('] [%name %p] [%punctuator %':'] [%type 'Point'] [%punctuator %')'] [%punctuator %'-'] [%punctuator %'>'] [%type 'Point'] [%punctuator %'{'] [%punctuator %'('] [%name %p] [%punctuator %'.'] [%name %x] [%name %p] [%punctuator %'.'] [%name %y] [%punctuator %')'] [%punctuator %'}'] [%punctuator %'}'] [%punctuator %';'] [%keyword %let] [%name %origin] [%punctuator %'='] [%type 'Point'] [%punctuator %'(('] [%literal [[%number p=50] q=%.n]] [%literal [[%number p=60] q=%.n]] [%punctuator %')'] [%punctuator %';'] [%name %origin]]
